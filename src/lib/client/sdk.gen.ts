...
import type { UserControllerGetProfileData, UserControllerGetProfileResponse, AuthControllerGetMeData, AuthControllerGetMeResponse, AuthControllerRegisterData, AuthControllerRegisterResponse, AuthControllerLoginData, AuthControllerLoginResponse, AuthControllerLogoutData, AuthControllerRefreshData, AuthControllerRefreshResponse } from './types.gen';
...
export const authControllerGetMe = <ThrowOnError extends boolean = false>(options?: Options<AuthControllerGetMeData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<AuthControllerGetMeResponse, unknown, ThrowOnError>({
        url: '/auth/me',
        ...options
    });
};
